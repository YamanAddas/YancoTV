...
interface CategoryDef {
   ...
   *
   * This array is a module-level constant evaluated once at import, so a
   * resolved string here would freeze whatever language happened to be active
   * at load and never update when the user switches. Same reason the sidebar's
   * nav items carry keys.
   */
  labelKey: StringKey;
  icon: string;
}
...
const categories: CategoryDef[] = [
  { id: 'general', labelKey: 'settings.general', icon: 'M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.066 2.573c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.573 1.066c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.066-2.573c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z M15 12a3 3 0 11-6 0 3 3 0 016 0z' },
  { id: 'playlists', labelKey: 'settingsTab.playlists', icon: 'M4 6h16M4 10h16M4 14h16M4 18h16' },
  { id: 'epg', labelKey: 'settingsTab.epg', icon: 'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z' },
  { id: 'playback', labelKey: 'settingsTab.playback', icon: 'M14.752 11.168l-3.197-2.132A1 1 0 0010 9.87v4.263a1 1 0 001.555.832l3.197-2.132a1 1 0 000-1.664z M21 12a9 9 0 11-18 0 9 9 0 0118 0z' },
  { id: 'subtitles', labelKey: 'settingsTab.subtitles', icon: 'M7 8h10M7 12h6M5 4h14a2 2 0 012 2v12a2 2 0 01-2 2H5a2 2 0 01-2-2V6a2 2 0 012-2z' },
  { id: 'recording', labelKey: 'settingsTab.recording', icon: 'M15 12a3 3 0 11-6 0 3 3 0 016 0z M12 21a9 9 0 110-18 9 9 0 010 18z' },
  { id: 'downloads', labelKey: 'nav.downloads', icon: 'M12 4v12m0 0l-4-4m4 4l4-4M4 20h16' },
  { id: 'parental', labelKey: 'settingsTab.parental', icon: 'M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z' },
  { id: 'network', labelKey: 'settingsTab.network', icon: 'M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9m-9 9a9 9 0 019-9' },
  { id: 'metadata', labelKey: 'settingsTab.metadata', icon: 'M4 6a2 2 0 012-2h12a2 2 0 012 2v12a2 2 0 01-2 2H6a2 2 0 01-2-2V6zm4 2h8m-8 4h8m-8 4h4' },
  { id: 'advanced', labelKey: 'settingsTab.advanced', icon: 'M10.5 6h3l.5 2.25 1.9 1.1 2.1-.9 1.5 2.6-1.6 1.6.1 2.2 1.6 1.6-1.5 2.6-2.1-.9-1.9 1.1-.5 2.25h-3l-.5-2.25-1.9-1.1-2.1.9-1.5-2.6 1.6-1.6-.1-2.2-1.6-1.6 1.5-2.6 2.1.9 1.9-1.1z M14 12a2 2 0 11-4 0 2 2 0 014 0z' },
  { id: 'shortcuts', labelKey: 'settingsTab.shortcuts', icon: 'M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-2.343M11 7.343l1.657-1.657a2 2 0 012.828 0l2.829 2.829a2 2 0 010 2.828l-8.486 8.485M7 17h.01' },
  { id: 'about', labelKey: 'settingsTab.about', icon: 'M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z' },
];
