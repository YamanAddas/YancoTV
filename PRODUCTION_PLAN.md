...
| 21.2 | Performance profiling | Profile renderer: fix unnecessary re-renders, optimize virtualized lists with 50K+ items | DONE (static) |
...
| 21.10 | Release prep | Version bumping, changelog, build pipeline verification, code signing (if available) | DONE (0.2.0 + CHANGELOG; signing deferred — no cert) |
