...
class PlacedFocusAnchorTest {
    @Test fun awaitAndRequestSuspendsUntilPlaced() =
    ...
    @Test fun awaitAndRequestFiresImmediatelyWhenAlreadyPlaced() =
        runTest(StandardTestDispatcher()) {
    ...
    @Test fun resetFlipsIsPlacedBackToFalse() =
        runTest(StandardTestDispatcher()) {
    ...
    @Test fun multipleAwaitAndRequestCallsAllResolve() =
        runTest(StandardTestDispatcher()) {
    ...
    @Test fun markPlacedIsIdempotent() =
        runTest(StandardTestDispatcher()) {
