 ...
 */
object YancoIcons {
    val Home: ImageVector = buildLine("home") {
        moveTo(3f, 11.5f); lineTo(12f, 3.5f); lineTo(21f, 11.5f)
        moveTo(5.5f, 10f); lineTo(5.5f, 20f); lineTo(18.5f, 20f); lineTo(18.5f, 10f)
        moveTo(10f, 20f); lineTo(10f, 14.5f); lineTo(14f, 14.5f); lineTo(14f, 20f)
    }

    val Live: ImageVector = buildLine("live") {
        moveTo(3f, 6f); lineTo(21f, 6f); lineTo(21f, 17f); lineTo(3f, 17f); close()
        moveTo(8f, 20f); lineTo(16f, 20f)
        moveTo(12f, 17f); lineTo(12f, 20f)
    }

    val Guide: ImageVector = buildLine("guide") {
        ...
        moveTo(15f, 9.5f); lineTo(15f, 19f)
    }

    val Movies: ImageVector = buildLine("movies") {
        moveTo(4f, 4f); lineTo(20f, 4f); lineTo(20f, 20f); lineTo(4f, 20f); close()
        moveTo(4f, 4f); lineTo(8f, 8f)
        moveTo(10f, 4f); lineTo(14f, 8f)
        moveTo(16f, 4f); lineTo(20f, 8f)
        moveTo(4f, 8f); lineTo(20f, 8f)
        moveTo(10.5f, 11.5f); lineTo(15.5f, 14.5f); lineTo(10.5f, 17.5f); close()
    }

    val Series: ImageVector = buildLine("series") {
        moveTo(3.5f, 7.5f); lineTo(20.5f, 7.5f); lineTo(20.5f, 18f); lineTo(3.5f, 18f); close()
        moveTo(8f, 4.5f); lineTo(12f, 7.5f)
        moveTo(16f, 4.5f); lineTo(12f, 7.5f)
        moveTo(7f, 20.5f); lineTo(17f, 20.5f)
    }

    val Favorites: ImageVector = buildLine("favorites") {
        moveTo(12f, 20f)
        lineTo(4.5f, 12.5f)
    ...
    val Search: ImageVector = buildLine("search") {
    ...
    val Settings: ImageVector = buildLine("settings") {
        moveTo(12f, 8.5f)
    ...
    val Play: ImageVector = buildLine("play") {
        moveTo(7f, 4.5f); lineTo(19f, 12f); lineTo(7f, 19.5f); close()
    }

    val StarOutline: ImageVector = buildLine("star-outline") {
        moveTo(12f, 3.5f)
        lineTo(14.7f, 9.3f)
        lineTo(21f, 10f)
        lineTo(16.2f, 14.2f)
    ...
    val StarFilled: ImageVector = buildFilled("star-filled") {
        moveTo(12f, 3.5f)
        lineTo(14.7f, 9.3f)
        lineTo(21f, 10f)
        lineTo(16.2f, 14.2f)
    ...
    val Lock: ImageVector = buildLine("lock") {
    ...
    val ChevronRight: ImageVector = buildLine("chevron-right") {
        moveTo(9f, 5f); lineTo(16f, 12f); lineTo(9f, 19f)
    }

    private fun buildLine(name: String, block: PathBuilder.() -> Unit): ImageVector =
        ImageVector.Builder(
            name = name,
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
    ...
    private fun buildFilled(name: String, block: PathBuilder.() -> Unit): ImageVector =
        ImageVector.Builder(
            name = name,
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
