...
private val SERIES_GROUP_PATTERNS = listOf(
    "series",
    "serie",
    "episode",
    "tv show",
...
private val MOVIE_GROUP_PATTERNS = listOf(
    "movie",
    "vod",
    "film",
    "cinema",
...
private val CATEGORY_NORMALIZATIONS: List<Pair<Regex, String>> = listOf(
    // Country prefixes.
