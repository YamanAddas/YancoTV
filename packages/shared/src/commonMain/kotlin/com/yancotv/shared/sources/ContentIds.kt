...
internal object ContentIds {
    fun m3u(sourceId: String, title: String, streamUrl: String): String = "$sourceId-${fnv1a("$title|$streamUrl")}"

    fun xtreamLive(sourceId: String, streamId: String): String = "$sourceId-xt-live-$streamId"

    fun xtreamVod(sourceId: String, streamId: String): String = "$sourceId-xt-vod-$streamId"

    fun xtreamSeries(sourceId: String, seriesId: String): String = "$sourceId-xt-series-$seriesId"

    fun stalkerLive(sourceId: String, channelId: String): String = "$sourceId-stk-live-$channelId"

    fun stalkerVod(sourceId: String, itemId: String): String = "$sourceId-stk-vod-$itemId"

    fun stalkerSeries(sourceId: String, seriesId: String): String = "$sourceId-stk-series-$seriesId"
