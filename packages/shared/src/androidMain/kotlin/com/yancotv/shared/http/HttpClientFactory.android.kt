 ...
 */
fun createAndroidHttpClient(userAgentProvider: () -> String, perRequestReadTimeoutMs: () -> Long?, cacheDir: File): HttpClient =
    AndroidKtorHttpClient(buildKtor(), userAgentProvider, perRequestReadTimeoutMs, cacheDir)
