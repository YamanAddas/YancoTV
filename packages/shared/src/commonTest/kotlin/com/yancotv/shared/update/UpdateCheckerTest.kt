...
class UpdateCheckerTest {
    private class FakeHttpClient(
        ...
        ): Any? = error("getJson not used in UpdateChecker")
    ...
    @Test fun emptyEndpoint_returnsNull() =
        runTest {
    ...
    @Test fun blankEndpoint_returnsNull() =
        runTest {
            val http = FakeHttpClient(Result.success(""))
            val checker = UpdateChecker(http, endpointUrl = "   ", currentVersionCode = 1)
    ...
    @Test fun httpFailure_returnsNull() =
        runTest {
    ...
    @Test fun missingDownloadUrl_returnsNull() =
        runTest {
    ...
    @Test fun remoteVersionEqualToCurrent_returnsNull() =
        runTest {
            val body =
                """
    ...
    @Test fun remoteVersionOlderThanCurrent_returnsNull() =
        runTest {
    ...
    @Test fun remoteVersionNewer_returnsUpdateInfoWithAllFields() =
        runTest {
            val body =
                """
                {
    ...
    @Test fun newerRemote_optionalFieldsAbsent_defaultsToNull() =
        runTest {
    ...
    @Test fun unknownFutureFields_ignoredNotErrored() =
        runTest {
    ...
    @Test fun urlPassedToHttpMatchesConfiguredEndpoint() =
        runTest {
